...
import FormEditUserPage from '../../homePage/profile/formEditUser';
import FormChangePassWord from '../../homePage/profile/formChangePassword';
                    ...
                    <Grid item xs={6} >
                        ...
                        {show && (
                            <>
                                ...
                                <Box sx={{display:'flex',marginTop:'12px'}}><Typography  sx={{fontWeight: 'bold', minWidth:'110px'}}>Avatar:</Typography>
                                    <img src={ user.avatar ? `http://localhost:8000/images/${user?.avatar}`
                                        : 'http://www.gravatar.com/avatar/?d=mp'} style={{width: '230px',height: '120px'}} alt="avatar" />
                                </Box>
